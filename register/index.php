        ...
        if($banco==0 && !isset($compra)){
            ...
            $product_id = rand(1111, 99999);
                mysqli_query($connection, "INSERT INTO purchases ('invoice', 'product_id', 'product_name', 'product_quantity', 'product_amount', 'payer_fname', 'payer_lname', 'payer_address', 'payer_city', 'payer_state', 'payer_zip', 'payer_country', 'payer_email', 'payment_status', 'posted_date') VALUES ('".$invoice."', '".$product_id."', 'Compra Promolider', '1', '$tiva', '".$_SESSION["nvirtual"]."', '".$_SESSION["nvirtual"]."', '', '', '', '', '', '', '', NOW())");
                    ...
                    $p->add_field('business', 'registro@promolider.org'); // Call the facilitator eaccount
                    ...
                    $p->add_field('amount_1', $montototalxd);
               ...
               $trasaction_id  = $_POST["txn_id"];
                ...
                <script type='text/javascript'>
                    var finalAmount = '<?=($montototalxd_en_soles*100)?>';
               ...
               <!-- <div class="body bg-gray">-->
                ...
                <h4 id="box-h4" style="background-color: #36424A;">Datos personales</h4>
                    <div class="form-group">
                        <input type="text" name="nombre" class="form-control" pattern="[A-Za-z\s]{3,250}" required placeholder="Nombre" title=" Nombre"/>
                    </div>
                    
                        <input type="hidden" name="snombre" class="form-control" pattern="[A-Za-z]{3,250}" placeholder="Segundo Nombre" title="Segundo nombre"/>
                    
                    <div class="form-group">
                        <input type="text" name="apellido" class="form-control" pattern="[A-Za-z\s]{3,250}" required placeholder="Apellido" title="Apellido"/>
                    </div>
                    
                        <input type="hidden" name="sapellido" class="form-control" pattern="[A-Za-z]{3,250}" placeholder="Segundo Apellido" title="Segundo apellido"/>
                    
                    <div class="form-group">
                        <input type="number" name="identificacion" class="form-control" pattern="[0-9]{3,20}" required placeholder="Identificación" title="Documento de ientificación"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="tlf_h" class="form-control" pattern="[\+0-9\-]{3,50}" placeholder="Telefono de Habitación" title="Telefono de habitación"/>
...
<div class="col-xs-12 col-md-4 col-lg-4">
                <h4 id="box-h4" style="background-color: #36424A;">Datos de la cuenta</h4>
                    <div class="form-group">
                        <input title="E-Mail" type="email" name="email" class="form-control" required placeholder="E-Mail"/>
                    </div>
                     <div class="form-group">
                        <input title="Usuario" type="text" name="usuario" class="form-control" pattern="[A-Za-z0-9]{2,250}" required placeholder="Usuario"/>
                    </div>
                     <div class="form-group">
                        <input title="Contraseña" type="password" name="passw" class="form-control" required placeholder="Contraseña"/>
                    </div>
                     <div class="form-group">
                        <input title="Repetir contraseña" type="password" name="cpassw" class="form-control" required placeholder="Repita la contraseña"/>
                    </div>
                <h4 id="box-h4" style="background-color: #36424A;">Referidor / Patrocinante</h4>
                     <div class="form-group">
                        ...
                        <!-- <input title="Twitter" type="hidden" name="twitter" class="form-control" placeholder="Twitter"/>
                   
                        <input title="Facebook" type="hidden" name="facebook" class="form-control" placeholder="Facebook"/>
                   
                        <input title="Skype" type="hidden" name="skype" class="form-control" placeholder="Skype"/> -->
...
<div class="col-xs-12 col-md-4 col-lg-4">                    
                ...
                <h4 id="box-h4" style="background-color: #36424A;">Tipo de cuenta</h4>
                 <div class="form-group">
                    <select title="Tipo de cuenta" required name="tipoc" id="afiliacion" class="form-control" onchange="cafiliacion();" required>
...
?>
        ...
        <div class="form-control">
            <input title="Lea y tílde los Términos y Condiciones" type="checkbox" required/> Acepto que he leido los <a target="_blank" href="http://promolider.org/sistema/images/terminos.pdf">Términos y Condiciones</a>
...
<script>
    ...
    function culqi() {
        if (Culqi.token) {
            ...
            var descripcion='Pago de afiliación';
            var precio = getFinalAmount();

            function waitForElement(){
                if(typeof precio === "string" && precio>300){
                    precio = '<?php echo ($montototalxd_en_soles*100)?>';
